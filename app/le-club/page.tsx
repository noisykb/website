        ...
        <section className="py-16 md:py-24">
          <div className="site-shell grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div>
              ...
              <h2 className="mt-5 text-4xl font-black leading-[1.05] tracking-[-0.025em] md:text-5xl">Noisy franchit un nouveau cap.</h2>
              <p className="mt-7 text-lg leading-relaxed text-[#4d5161]">En mai 2026, l’équipe masculine de Noisy est devenue championne régionale de la Ligue Est. Ce titre lui ouvre désormais les portes de la <strong className="text-[#11152b]">D2 nationale</strong>, où elle affrontera de nouveaux adversaires lors des prochains Opens.</p>
              <p className="mt-5 text-lg leading-relaxed text-[#4d5161]">Le club rayonne aussi au-delà de ses équipes : avec Pauline Gadé, médaillée de bronze avec l’équipe de France féminine à la Coupe d’Europe 2026, Noisy est représenté jusque sur les terrains internationaux.</p>
