...
export default function NotFound() {
  return (
    <main className="grid min-h-screen place-items-center bg-[#0d2b47] px-5 text-center text-white">
      <div>
        <p className="font-mono text-sm font-bold text-[#dfff45]">ERREUR 404</p>
